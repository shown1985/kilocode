...
- Never echo the literal <environment_details>, <files>, or similar XML tags back to the user. Read the information, extract the relevant facts, and present them as clear natural language or Markdown lists/tables so the user sees a rendered explanation instead of raw tags.
